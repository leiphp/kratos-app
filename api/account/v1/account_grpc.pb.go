...
const (
	Account_Login_FullMethodName    = "/api.account.v1.Account/Login"
	Account_Register_FullMethodName = "/api.account.v1.Account/Register"
...
func (c *accountClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoReply, error) {
	out := new(InfoReply)
...
func (UnimplementedAccountServer) Info(context.Context, *InfoRequest) (*InfoReply, error) {
